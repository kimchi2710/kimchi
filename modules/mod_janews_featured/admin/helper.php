...
class JAAdminHelper
{
    ...
    function cloneProfile()
    {
        ...
        if (!JFile::exists($source) && $template) {
            $source = JPATH_SITE . DS . 'templates' . DS . $template . DS . 'html' . DS . 'mod_janews_featured' . DS . $fromprofile . '.ini';
        }
    ...
    function deleteProfile()
    {
        ...
        if (!$return) {
            ...
            $source = JPATH_SITE . DS . 'templates' . DS . $template . DS . 'html' . DS . 'mod_janews_featured' . DS . $profile . '.ini';
    ...
    function changeTheme()
    {
        ...
        if ($theme) {
            $xml_theme = JPATH_SITE . DS . 'templates' . DS . $template . DS . 'html' . DS . 'mod_janews_featured' . DS . $theme . DS . 'params.xml';
            if (!JFile::exists($xml_theme) || !$template) {
                $xml_theme = JPATH_SITE . DS . 'modules' . DS . 'mod_janews_featured' . DS . 'tmpl' . DS . $theme . DS . 'params.xml';
            }
