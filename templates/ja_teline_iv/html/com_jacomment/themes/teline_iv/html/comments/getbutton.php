...
?>
	<?php if($display_comment_link){?>	
		<div class="jac-add-button"><a class="jac-links" href="<?php echo $links; ?>" title="<?php echo JText::_('ADD_COMMENT'); ?>"><?php echo JText::_('JADD_COMMENT'); ?></a>
...
<?php if($typeDisplay == "onlyButton" && $display_comment_link):?>	
	<a class="jac_links jac-links<?php echo $id;?>" href=<?php echo $links; ?> title="<?php echo JText::_('ADD_COMMENT'); ?>"><?php echo JText::_('JADD_COMMENT'); ?></a>	
<?php endif; ?>
